...
const CardWithCta = ({ type, className }) => (
  <div
    className={clsx(
      'hover:drop-shadow-book flex h-full w-full flex-col justify-between overflow-hidden rounded-lg border sm:flex-row sm:pt-5 [@media(max-width:480px)]:!flex-col',
      cardTypes[type].style,
      className
    )}
  >
    <div className="flex flex-col pt-6 pl-6 pr-5 xs:pb-0 sm:pb-5 sm:pt-0">
