...
const ListCard = ({ type, title, date, place, linkUrl, className }) => (
  <div
    className={clsx(
      'md:first:bt border-gray-90 flex h-auto w-full flex-col border-t border-dashed py-6 first:border-none first:pt-0 md:first:border-dashed md:first:pt-6 lg:first:border-t',
      className
    )}
  >
