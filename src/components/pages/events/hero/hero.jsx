...
const Hero = ({ items }) => {
  ...
  return (
    <section className="safe-paddings pt-20 pb-10 md:pb-4 lg:pt-16 lg:pb-6">
      <div className="container flex flex-col">
        ...
        {items.length > 0 && (
          <div className="grid w-full grid-cols-12 gap-x-8 md:gap-x-0">
            ...
            <div className="md:last:border-gray-90 col-span-5 col-start-8 flex flex-col md:col-span-12 md:col-start-1 md:last:border-b md:last:border-dashed">
