...
const AdopterTestimonial = ({ testimonial }) => (
  <div
    ...
    <div className="lg:flex">
      <div className="lg:flex lg:items-center lg:gap-6">
        <div className="lg:flex lg:flex-col lg:justify-between lg:gap-4">
          <img src={company.imgSrc} alt={company.alt} className="w-[257px]" />
          <p className="lg:max-w-[650px]">{company.intro}</p>
          <a href="www.rvvvvrvrv" className="font-bold uppercase text-[#0073E5]">
        ...
        <div className="hidden h-[180px] w-[1px] bg-[#A7B1BE] lg:block" />
      </div>
      <div className="mx-auto text-center lg:flex lg:flex-col lg:items-center lg:justify-between">
        ...
        <p>{company.details}</p>
        <p>
          <span className="font-bold">{company.profileName}</span>,{' '}
          <span className="text-[#6C7993]">{company.role}</span>
        </p>
      </div>
    </div>
  </div>
...
AdopterTestimonial.propTypes = {
  ...
  qoutedText: PropTypes.string.isRequired,
