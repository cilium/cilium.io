    ...
    <div className="flex flex-col flex-wrap gap-8 md:grid md:grid-cols-2 md:gap-8 lg:grid lg:grid-cols-3 lg:gap-16">
      ...
      >
        ...
        <p className="mx-auto h-[180px] w-full max-w-[320px] pt-4 pb-6">
          Cilium is an open source project that anyone in the community can use, improve, and enjoy.
          We'd love you to join us! Find out what's happening and get involved.
        </p>
      ...
      >
        ...
        <p className="mx-auto h-[180px] w-full max-w-[320px] pt-4 pb-6">
          Get help with Cilium through Slack, Github, training, support, and FAQs. The community can
          also help you tell or promote your story around Cilium.
        </p>
        <a href="https://cilium.herokuapp.com/" target="_blank" rel="noopener noreferrer">
          <button
            type="button"
