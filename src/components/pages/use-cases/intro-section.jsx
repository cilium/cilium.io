...
const IntroSection = ({
  ...
  <Container className="grid grid-cols-12 gap-y-6 gap-x-6 pt-5 pb-10 md:pt-16  md:pb-20 xl:gap-x-8">
    <div
    ...
    {(imageSrc || videoSrc) && (
      <div className="col-span-full col-start-1 pt-6 md:col-span-8 md:col-start-3 lg:col-span-6 lg:pt-14">
        {isImage ? (
