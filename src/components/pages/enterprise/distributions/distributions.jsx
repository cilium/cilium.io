  ...
  <section className="bg-gray-4 pb-12 pt-11 md:pb-20 md:pt-16 lg:pt-24 lg:pb-28 xl:pb-32">
    <Container>
      ...
      <div className="mt-6 flex flex-col divide-y divide-gray-3 rounded-xl bg-white px-8 py-8 shadow-card md:mt-10 lg:mt-14 lg:flex-row lg:divide-x lg:divide-y-0 lg:px-0">
        <div className="flex-1 pb-6 lg:px-6 lg:pb-0 xl:max-w-[340px] xl:px-8">
        ...
        {items.map(({ name, icon: Icon }, index) => (
          <div
            className="flex flex-1 flex-col items-stretch space-y-4 py-6 last:pb-0 xs:flex-row xs:items-center xs:space-y-0 xs:space-x-4 lg:flex-col lg:items-stretch lg:space-x-0 lg:space-y-4 lg:px-6 lg:py-0 xl:px-8"
            key={index}
          >
