...
const Training = () => (
  <section className="py-10 md:py-20 lg:py-28">
    <Container className="flex space-y-6 md:space-y-10 xl:space-y-0 xl:space-x-28  xl:items-center flex-col xl:flex-row">
      ...
      <div className="flex-grow pt-9 pb-11 md:pb-16 lg:pb-20 bg-grid bg-cover sm:bg-contain bg-center bg-no-repeat">
        <div className="max-w-[384px] relative mx-auto flex flex-col text-center px-8 pb-8 pt-11 shadow-card bg-white rounded-xl">
