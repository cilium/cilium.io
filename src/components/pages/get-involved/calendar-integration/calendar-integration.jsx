...
const CalendarIntegration = () => {
  return (
    <section className="py-10 calendar-integration md:py-16 lg:py-20">
      <Container>
        <div className="mb-8 text-center">
          <Heading className="text-white" tag="h2">
            Community Calendar
          </Heading>
          <p className="max-w-2xl mx-auto mt-5 text-lg text-white">
        ...
        <div className="overflow-hidden bg-white rounded-lg shadow-lg">
          <div className="aspect-w-16 aspect-h-10 md:aspect-h-12 lg:aspect-h-14">
            <iframe
