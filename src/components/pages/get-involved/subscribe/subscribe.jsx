          ...
          >
            <input
              className={classNames(
                ...
                'hover:border-gray-2 focus-visible:border-transparent focus-visible:outline-none',
                errors?.email?.message || errorMessage
                  ? 'ring-2 ring-additional-1 ring-offset-0'
                  : 'focus-visible:ring-2 focus-visible:ring-primary-1 focus-visible:ring-offset-0'
              )}
              type="email"
              name="email"
