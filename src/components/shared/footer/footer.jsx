...
const Footer = () => (
  <footer className="mt-20 lg:mt-28 ">
    <Container className="pt-10 pb-10 border-t lg:pt-14 lg:pb-16 border-gray-3">
      <div className="grid grid-cols-3 space-y-10 lg:grid-cols-4 gap-x-8 lg:space-y-0">
        <Link to="/">
      ...
      <div className="mt-10 space-y-3 text-sm lg:mt-16 with-link-primary text-gray-1">
