export default {
  ...
  michelin: {
    iconName: 'michelin',
    text: '<b>Michelin</b> consolidated on Cilium as their single CNI, gaining network visibility at scale with Hubble',
    links: [
      {
        linkText: 'Case Study',
        linkUrl: 'https://www.cncf.io/case-studies/michelin-2/',
        linkTarget: '_blank',
      },
    ],
  },
