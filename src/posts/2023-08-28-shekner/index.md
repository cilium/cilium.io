...
_August 28th, 2023_
_Author: Amir Kheirkhahan, BD Schneker_
...
![After Starting the Rotation](after-starting-the-rotatation.png)

![Draining the oldest worker node](draining-the-oldest-worker-node.png)

Node A is removed from the LoadBalancer so that it no longer receives traffic, and then terminated
...
_Goldpinger UI after cilium installation_
