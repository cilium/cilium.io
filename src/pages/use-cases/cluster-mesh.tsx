      ...
      <section className="bg-[#F6F7F8]">
        ...
        <div className="py-16">
          <div className="container mx-auto w-10/12">
            <div className="block items-center gap-8 md:flex">
              <div className="pb-4 md:basis-[55%] md:pb-0 lg:basis-2/4">
                <h3 className="mb-4 text-xl font-bold ">ClusterMesh - Cilium’s multi-cluster Networking Implementation</h3>
                <p>
        ...
        <div className="mt-12 mb-12">
          <div className="container mx-auto w-10/12">
            <h3 className="mb-8 text-center text-xl font-bold">Who’s using Cilium for Multi Cluster Networking?</h3>
